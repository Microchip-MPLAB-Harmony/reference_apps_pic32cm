...
# Example of DAC wave generation on PIC32CM LS00 Curiosity Nano+ Touch Evaluation Kit
<h2 align="center"> <a href="https://github.com/Microchip-MPLAB-Harmony/reference_apps/releases/latest/download/dac_wav_gen.zip" > Download </a> </h2>
...
Refer [Project Manifest](./firmware/dac/src/config/pic32cm_ls00_cnano/harmony-manifest-success.yml) present in harmony-manifest-success.yml under the project folder *firmware\dac\src\config\pic32cm_ls00_cnano*  
- Refer the [Release Notes](../../../../../release_notes.md#development-tools) to know the **MPLAB X IDE** and **MCC** Plugin version. Alternatively, [Click Here](https://github.com/Microchip-MPLAB-Harmony/reference_apps/blob/master/release_notes.md#development-tools).
- Use the [Saleae Logic Software](https://articles.saleae.com/logic-analyzers/what-is-a-logic-analyzer) to monitor the output.
...
- Open the project (dac_wave_gen\firmware\dac\pic32cm_ls00_cnanogroup) in MPLAB X IDE
...
- Observe a sine wave of 1 kHz frequency on DAC output pin PA02
- Press SW1 to switch the waveform shape between sine wave and sawtooth wave, and vice versa.
 
## Logic Analyzer Output:
- The following sinewave output is displayed on Saleae logic application

   <img src = "images/sine_wave_output.png" width="750" height="150" align="middle">
- After pressing SW1, the sine wave switches to a sawtooth wave and vice versa

   <img src = "images/sawtooth_wave_output.png" width="750" height="150" align="middle">
