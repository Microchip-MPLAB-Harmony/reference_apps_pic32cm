...
# Example of RTC Periodic Interrupt on PIC32CM LS00 Curiosity Nano+ Touch Evaluation Kit
...
> This example application demonstrates how to use the 32-bit timer mode of the RTC to generate periodic ticks. It toggles an LED1 every time the callback is triggered.
...
- Peripheral Modules
    ...
    <img src = "images/project_graph.png" width="650" height="380" align="center">
...
Refer [Project Manifest](./firmware/rtc/src/config/pic32cm_ls00_cnano/harmony-manifest-success.yml) present in harmony-manifest-success.yml under the project folder *firmware\rtc\src\config\pic32cm_ls00_cnano*  
...
- Open the project (rtc_periodic_timeout\firmware\rtc\pic32cm_ls00_cnanogroup) in MPLAB X IDE
- Ensure "PIC32CM LS00 Curiosity Nano" is selected as hardware tool to program/debug the application
- Build the code and program the device by clicking on the "make and program" button in MPLAB X IDE tool bar
- Follow the steps in "Running the Demo" section below

## Running the Demo:
- An LED1 on the PIC32CM LS00 Curiosity Nano+ Touch Evaluation Kit is toggles continuously
