...
#ifndef _PIC32CMGV00_TC_COMPONENT_H_
#define _PIC32CMGV00_TC_COMPONENT_H_
...
#define   TC_CTRLA_PRESCALER_DIV1_Val         _UINT16_(0x0)                                        /* (TC_CTRLA) GCLK_TC  */
#define   TC_CTRLA_PRESCALER_DIV2_Val         _UINT16_(0x1)                                        /* (TC_CTRLA) GCLK_TC/2  */
#define   TC_CTRLA_PRESCALER_DIV4_Val         _UINT16_(0x2)                                        /* (TC_CTRLA) GCLK_TC/4  */
#define   TC_CTRLA_PRESCALER_DIV8_Val         _UINT16_(0x3)                                        /* (TC_CTRLA) GCLK_TC/8  */
#define   TC_CTRLA_PRESCALER_DIV16_Val        _UINT16_(0x4)                                        /* (TC_CTRLA) GCLK_TC/16  */
#define   TC_CTRLA_PRESCALER_DIV64_Val        _UINT16_(0x5)                                        /* (TC_CTRLA) GCLK_TC/64  */
#define   TC_CTRLA_PRESCALER_DIV256_Val       _UINT16_(0x6)                                        /* (TC_CTRLA) GCLK_TC/256  */
#define   TC_CTRLA_PRESCALER_DIV1024_Val      _UINT16_(0x7)                                        /* (TC_CTRLA) GCLK_TC/1024  */
...
#define   TC_CTRLA_PRESCSYNC_GCLK_Val         _UINT16_(0x0)                                        /* (TC_CTRLA) Reload or reset Counter on next GCLK  */
#define   TC_CTRLA_PRESCSYNC_PRESC_Val        _UINT16_(0x1)                                        /* (TC_CTRLA) Reload or reset Counter on next prescaler clock  */
#define   TC_CTRLA_PRESCSYNC_RESYNC_Val       _UINT16_(0x2)                                        /* (TC_CTRLA) Reload or reset Counter on next GCLK. Reset prescaler counter  */
...
#define   TC_CTRLBCLR_CMD_RETRIGGER_Val       _UINT8_(0x1)                                         /* (TC_CTRLBCLR) Force start, restart or retrigger  */
#define   TC_CTRLBCLR_CMD_STOP_Val            _UINT8_(0x2)                                         /* (TC_CTRLBCLR) Force stop  */
...
#define   TC_CTRLBSET_CMD_RETRIGGER_Val       _UINT8_(0x1)                                         /* (TC_CTRLBSET) Force start, restart or retrigger  */
#define   TC_CTRLBSET_CMD_STOP_Val            _UINT8_(0x2)                                         /* (TC_CTRLBSET) Force stop  */
...
#define   TC_EVCTRL_EVACT_PPW_Val             _UINT16_(0x5)                                        /* (TC_EVCTRL) Period captured into CC0 Pulse Width in CC1  */
#define   TC_EVCTRL_EVACT_PWP_Val             _UINT16_(0x6)                                        /* (TC_EVCTRL) Period captured into CC1 Pulse Width on CC0  */
...
#endif /* _PIC32CMGV00_TC_COMPONENT_H_ */
